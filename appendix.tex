\section*{\hspace{1.5cm} Driftling lanes from the Slagen refinery}
...
This sort of maps could be made and categorised by weather pattern or another known factor, and in turn e.g. be used in the unlikely event of a spill in the time between the spill happening, and the forecast of oil drift is received. 
