...
\begin{center}
  \begin{tabular}{ | c | c | c |}
    ...
    \hline
  \end{tabular}
\caption{Skillscore of drifter trajectories released during the September 2015 cruise. We have used a tolerance treshold $n=2$ to get positive values for most trajectories. The number in parenthesis indicates how many hours the model trajectory is.}
