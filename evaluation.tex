...
\caption{\small 
Simulated (black) and observed (red) time series of tides (upper panel) and residual (lower panel) at Oscarsborg (\ref{fig:kart_obs}). The tidal elevation is composed of the eleven components included in the tidal forcing only. The residual is the total water level from which is subtracted the tidal elevation due to these eleven constituents.} 
...
The tidal forcing at the southern open boundary of the model includes eleven tidal components. Corresponding amplitudes and phases are used for the depth integrated currents and water level as described by \cite{roed:etal:2016}. As depicted by the time series shown in the upper panel of Fig.~\ref{fig:Waterlevel_jan15}, showing the tidal elevation due to these eleven components at Oscarsborg, model and observations are in fairly good agreement. We also note that, as shown by the lower panel of Fig.~\ref{fig:Waterlevel_jan15}, the residuals compares fairly well. This is further corroborated by a comparison of the simulated and observed tidal amplitudes and phases for thirteen individual tidal constitutents at all the three tidal gauge stations Viker, Oscarsborg and Oslo as displayed by Tab.\-\ref{tab:Tide}. Note that Tab.\-\ref{tab:Tide} shows the result for three tidal components not included in the tidal forcing. For instance tidal components with periods of approximately one year (SA) and half a year (SSA) are present in both the observations and the simulations. In addition, the observations have more tidal components with shorter periods which are not included in the tidal forcing, and thereby not present in the simulations (Fig.~\ref{fig:Waterlevel_freq}). This is consistent with the frequency series of the Fourier transformed water level (Fig.~\ref{fig:Waterlevel_tide}).
...
\caption{\small 
Frequency series of Fourier transformed observed (upperpanel) and simulated (lower panel) water levels at Oscarsborg} 
...
The strongest currents were found at the two northernmost moorings at the entrance to the Dr{\o}bak Sound, namely Filtvedt and Brenntangen. Here the fjord is relatively narrow, and hence the somewhat stronger current may be explained by a stronger tidal signal due to the tapering of the width of the fjord at the entrance to the Dr{\o}bak Sound. We also note that the stations with the shallowest depth exhibits the highest current velocities. This may be explained by the fact that the horizontal pressure gradient has a tendency to decrease with depth.

In the remaining part we restrict the evaluation regarding currents to three of the seven rigs equipped with an ADCP (Section \ref{subsec:curreo}), that is, the two northern moorings at Filtvedt and Brenntangen at the entrance to the Dr{\o}bak Sound, and the mooring Slagen near {\AA}sg\aa{}rdstrand. The rationale is that the remaining four moorings did not add any significant new insight other than corroborating the evaluation results gathered from comparing the simulated and observed currents at these three stations.
...
Figure~\ref{fig:Filtvedt-cur} shows the observed and simulated currents at Filtvedt. The observed currents at Brenntangen is similar in strength and variance, but the peaks in current strength do not occur at the same time (not shown). Note that since the observations are dominated by noise in the upper 35-40 meters, only depths larger than 40 meters are included in the comparison. As revelad by Figure~\ref{fig:Filtvedt-cur} the 3D current field is complex. It varies horizontally as well as vertically and in time. This is also reflected in the simulations as revealed by Figure~\ref{fig:Filtvedt-simcur} showing the simulated currents at three different depths. As shown the currents are in general stronger in the upper water masses than further down. In the upper layers the currents are towards north, while at 40 meters depth the currents are in the opposite direction, that is, southward. At 100 meters depth they again is directed northward. Because of the complex flow pattern, the currents at any given position cannot be taken at representative for the whole area. At 100 meters depth the currents at Filtvedt are weak and towards south even though the currents at 100 meters depth is generally stronger and towards north. At 40 meters depth the currents at Brenntangen is weaker than in the rest of the cross section. Note that the depth at Brenntangen is only 58 meters in the observations while in the depth is 46 meters at the corresponding point in the simulations. 
