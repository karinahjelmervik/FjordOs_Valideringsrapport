...
Testing with popcorn indicate that the preferred direction of the surface currents are towards Bliksekilen located west of the Slagen Refinery.
...
\begin{figure}[ht]
\centerline{
\includegraphics*[width=.55\textwidth]{Figurer/opendrift_godafoss_shortest_time_crop}}
\centerline{
\includegraphics*[width=.55\textwidth]{Figurer/opendrift_slagen_shortest_time_crop}}
\caption{\small
Number of hours from oil release, to oil in given area. Godafoss top, Slagen bottom. Based on one year (April 1st 2015 - April 1st 2016) of simulations, with a maximum lifetime of 15 days og the released particles.}
\label{fig:Ferrybox_temp_salt}
\end{figure}
